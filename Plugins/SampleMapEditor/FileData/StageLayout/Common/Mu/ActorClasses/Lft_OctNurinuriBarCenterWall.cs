...
{
	public class Lft_OctNurinuriBarCenterWall : MuObj
	{
		[BindGUI("AttCalcType", Category = "Lft_OctNurinuriBarCenterWall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("InterpolationType", Category = "Lft_OctNurinuriBarCenterWall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveSpeed", Category = "Lft_OctNurinuriBarCenterWall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("MoveTime", Category = "Lft_OctNurinuriBarCenterWall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("PatrolType", Category = "Lft_OctNurinuriBarCenterWall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("SpeedCalcType", Category = "Lft_OctNurinuriBarCenterWall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime", Category = "Lft_OctNurinuriBarCenterWall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("FreeRotateVelDegPerSec", Category = "Lft_OctNurinuriBarCenterWall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeBreakTime", Category = "Lft_OctNurinuriBarCenterWall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeReverseBreakTime", Category = "Lft_OctNurinuriBarCenterWall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateAngleDeg", Category = "Lft_OctNurinuriBarCenterWall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateTime", Category = "Lft_OctNurinuriBarCenterWall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("OneTimeRotateType", Category = "Lft_OctNurinuriBarCenterWall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("WaitTime1", Category = "Lft_OctNurinuriBarCenterWall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEventOnly", Category = "Lft_OctNurinuriBarCenterWall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsNotReplaceMapPart", Category = "Lft_OctNurinuriBarCenterWall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsIncludeVArea", Category = "Lft_OctNurinuriBarCenterWall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("IsEnableMoveChatteringPrevent", Category = "Lft_OctNurinuriBarCenterWall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		[BindGUI("ToRailPoint", Category = "Lft_OctNurinuriBarCenterWall Properties", ColumnIndex = 0, Control = BindControl.Default)]
		...
		public Lft_OctNurinuriBarCenterWall() : base()
		{
		...
		public Lft_OctNurinuriBarCenterWall(Lft_OctNurinuriBarCenterWall other) : base(other)
		{
		...
		public override Lft_OctNurinuriBarCenterWall Clone()
		{
			return new Lft_OctNurinuriBarCenterWall(this);
		}
